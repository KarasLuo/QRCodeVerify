...
import com.qrcode.verify.ScanFragment;
...
//    Log.e(TAG,"handleMessage:");
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
        Log.e(TAG,"handleMessage:decode_succeeded");
        state = State.SUCCESS;
...
//        Log.e(TAG,"decode_failed");
      ...
      case R.id.return_scan_result:
        ...
        fragment.getHoldingActivity().setResult(Activity.RESULT_OK, (Intent) message.obj);
        fragment.getHoldingActivity().finish();
        break;
      case R.id.launch_product_query:
        ...
        ResolveInfo resolveInfo =
                fragment.getHoldingActivity().getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY);
